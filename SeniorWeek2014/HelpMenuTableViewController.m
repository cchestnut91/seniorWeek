...
- (void)viewDidLoad
{
    ...
    self.questionArray = [NSArray arrayWithObjects:@"What is Senior Week?", @"Can I bring friends?", @"How do I get into events?", @"How do I get to events?", @"Where do I get a Senior Pass?", @"How do I pick it up?", @"Why do you need my location?", @"Question about this app?", nil];
    self.answerArray = [NSArray arrayWithObjects:@"Senior Week is a week long celebration of your time here at Ithaca College. Plus, it's a great way to spend the time between finals and graduation. Enjoy a variety of events with your friends before stepping off campus as an alumni.", @"Anyone with a Senior Pass can get into the events, and some of the events allow for friends without Senior Passes to join, like the Senior Formal or the Senior Splash. The Senior Formal costs $35 for guests.", @"To get into events, just bring your Senior Pass! Some events require some extra stuff, like ID if you want to drink. Check the event details in this app for more information", @"For many events transportation is provided by the Senior Week Committee. Check the events details for transportation info to see bus stop locations and times.", @"Senior Passes were only on sale for a three day window in early April.", @"Pickup your Pass between 11am and 3pm at Emerson Suites on May 8th or 9th. You can also pick up your Pass at the first event you go to.", @"This app delivers promotions and interesting information while you're at events. To do this, we use Bluetooth to connect with devices at the events. So to receive these promotions, just allow Location Services and turn on Bluetooth.", @"Email the developer", nil];
